  ...
  return (
    <View style={[styles.block, styles.block_layout]}>
      ...
      <Px.View
        ...
        <Px.ImageBackground
          x="0px 343fr 5px"
          y="289px minmax(0px, max-content) 73px"
          absolute
          ...
          <Px.View
            ...
            <View style={styles.block2_item}>
              <Px.View
                ...
                <View style={styles.flex17_space} />
                <View style={styles.flex17_item1}>
                  <Px.View
                    x="0px 243fr 0px"
                    ...
                    <Px.View
                      ...
                      <View style={styles.flex18_item}>
                        <Px.View
                          ...
                          <View style={styles.flex19_space1} />
                          <View style={styles.flex19_item2}>
                            <Px.ImageBackground
                              x="0px 12fr 0px"
                ...
                <Px.View
                  ...
                  <View style={styles.flex5_item}>
                    <Px.ImageBackground
                      ...
                      source={require('../assets/619db2d1d86fb9b0254d80a769926bcc.png')}
                      resizeMode="contain">
                      <View style={[styles.block3, styles.block3_layout]}>
                        <ImageBackground
                    ...
                    <Px.View
                      ...
                      <View style={styles.flex6_item}>
                        <Px.View
                          ...
                          <View style={styles.flex7_item2}>
                            <Px.ImageBackground
                              x="0px 12fr 0px"
                              y="15px minmax(0px, max-content) 3px"
                              style={styles.cover_block10}
                              source={require('../assets/cdfc0d4748e7637340634db1ca4defec.png')}
                              resizeMode="contain">
                              <ImageBackground
                    ...
                    <Px.View
                      ...
                      <View style={styles.flex14_item}>
                        <Px.View
                          ...
                          <ImageBackground
                            style={[styles.image1, styles.image1_layout1]}
                            source={require('../assets/75afd001f65f76dda3c374ae82e36707.png')}
                          />
                        </Px.View>
                      </View>
                    ...
                    <Px.View
                      ...
                      <View style={styles.flex1_item}>
                        <Px.View
                          ...
                          style={styles.cover_block15}>
                          <ImageBackground
                            style={[styles.image1, styles.image1_layout2]}
                            source={require('../assets/75afd001f65f76dda3c374ae82e36707.png')}
                          />
                        </Px.View>
                      </View>
        ...
        <Px.ImageBackground
          x="0px 348fr 0px"
          y="0px minmax(0px, max-content) 671px"
        ...
        <Px.View
          ...
          <View style={styles.cover_block2_space} />
          <View style={styles.cover_block2_item1}>
            <ImageBackground
        ...
        <Px.ImageBackground
          ...
          <View style={styles.cover_block1_item}>
            <ImageBackground
              style={[styles.icon8, styles.icon8_layout]}
...
Frame4.inStorybook = true;
Frame4.fitScreen = false;
Frame4.scrollHeight = 728;
